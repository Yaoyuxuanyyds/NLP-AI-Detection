...
# Configure logging
logging.basicConfig(filename='/root/yyx/Multiple_Detection/logs/train_BERT_TF.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
for PCA_DIMENSION in PCA_DIMENSIONs:
    ...
    logging.info("="*50)
    print("="*50)
    logging.info(f"Training BERT + TF-IDF features with Dimension-{PCA_DIMENSIONI}...")
    print(f"Training BERT + TF-IDF features with Dimension-{PCA_DIMENSIONI}...")
    # Train the model
